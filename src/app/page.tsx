...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-10 pb-16">
      {/* Hero Banner with University Extension badge */}
      <section className="relative overflow-hidden border-b border-collegiate-border/80 bg-gradient-to-b from-collegiate-dark via-collegiate-surface/40 to-collegiate-dark px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-5xl text-center space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/40 bg-amber-950/40 px-4 py-1.5 text-xs sm:text-sm font-bold text-amber-300 backdrop-blur shadow-sm">
            ...
            <span>Circuito de Extensão Universitária • Esporte Acadêmico & Comunidade</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="/torneios/novo"
              className="flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-3.5 text-sm sm:text-base font-bold text-white shadow-xl shadow-emerald-900/40 hover:bg-emerald-500 active:scale-95 transition-all border border-emerald-500"
            >
      ...
      <section id="torneios-section" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full space-y-6 pt-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Explore os torneios ativos, acompanhe os chaveamentos ou inscreva-se
            </p>
          </div>

          <Link
            href="/torneios/novo"
            className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-4 py-2 text-xs sm:text-sm font-bold text-white hover:bg-emerald-500 transition-all self-start sm:self-auto"
          >
        ...
        {tournaments.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-800 bg-slate-900/40 p-12 text-center space-y-4">
            ...
            <Link
              href="/torneios/novo"
              className="rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-bold text-white hover:bg-emerald-500 transition-all shadow-md shadow-emerald-600/30"
            >
