...
export default function NovoTorneioPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    maxSets: 1, // 1, 3 (padrão 1 set em torneios de bairro para agilidade)
    community: "Rio Doce",
    location: "Orla de Rio Doce - Mesa da Praia",
    sponsors: "Comércio Local de Olinda • Projeto Futmesa na Quebrada",
    rulesNote: "Padrão Pernambucano: 18 pontos com diferença de 2 pontos. Sem pisar dentro da área da mesa.",
        ...
        <div className="flex items-center gap-3 border-b border-collegiate-border/80 pb-5 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-black text-white tracking-tight">
              Criar Campeonato Comunitário em Olinda
            </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              name="title"
              required
              placeholder="Ex: 1º Torneio Comunitário de Futmesa da Orla de Rio Doce"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full rounded-xl border border-collegiate-border bg-collegiate-dark/90 px-4 py-3 text-sm text-white focus:border-amber-400 focus:outline-none"
              >
                <option value={15}>15 Pontos (Diferença de 2 - Rápido)</option>
                <option value={18}>18 Pontos (Padrão Futmesa Olinda)</option>
          ...
          {/* Apoiadores / Patrocinadores Locais */}
          <div className="space-y-2">
            <label
              htmlFor="sponsors"
              className="text-xs font-bold uppercase tracking-wider text-emerald-100/90 flex items-center gap-1.5"
            ...
            <input
              ...
              id="sponsors"
              name="sponsors"
              placeholder="Ex: Barbearia da Esquina • Açougue do Zé • Projeto Futmesa na Quebrada"
